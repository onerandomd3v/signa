...
func TestRuleBasedEvaluatorPreservesPairwiseSignalsAndTiming(t *testing.T) {
	tests := []struct {
		...
		{name: "distinct origins and dissimilar synchronized reports", observations: withOrigins(observations(t, []string{"smoke beside the market", "water rising near the bridge"}, true), "origin-private-1234", "origin-private-5678"), wantState: "possible_coordination", wantFactors: map[string]string{"source_origin": "independence_support"}},
